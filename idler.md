...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-14">
        ...
        <!-- Overview Image -->
        <img src="./pics/research/idleronlinegraphic.png" alt="Idler Compounds overview" class="content-img">
    </div>
    ...
    <div class="mb-14">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                <img src="./pics/research/Idlercompounds.png" alt="Idler library composition and property distributions" class="content-img mt-0">
            </div>
            <div>
                <img src="./pics/research/Idlercompounds2.png" alt="Activity/solubility plate maps and highlighted compounds" class="content-img mt-0">
            </div>
        </div>
    </div>
    ...
    <div class="mb-14">
        ...
        <div class="bg-slate-50 p-5 rounded-sm border border-slate-200 inline-block hover:border-brand-primary transition-colors group">
    ...
    <!-- Footer Note -->
    <div class="border-t border-slate-200 pt-6 mt-12">
        <p class="text-sm text-slate-400 italic font-medium">Last updated: Aug 2025</p>
    </div>
